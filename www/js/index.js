...
function successCallback(position) { 
        ...
        $.ajax({
	        url:"//api.openweathermap.org/data/2.5/weather?lat=" +lat + "&lon=" + lng +"&APPID=92e7b2df78fb8de10187e0abd8c5a46b",
	        type: "get",
	        crossDomain: true,
	        dataType:"jsonp",
	     ...
	     $.ajax({
	    	url: "//openapi.airkorea.or.kr/openapi/services/rest/ArpltnInforInqireSvc/getMsrstnAcctoRltmMesureDnsty?stationName=" + gugugu +"&dataTerm=month&pageNo=3&numOfRows=1&ServiceKey=DZ2bt4fg7QwJULCmQrMY0R1hRCJ8zNpPGzLWL7s1%2FpI04Ih5gF6ggxbvvBpBkCoYSFlAOccv2kVnMUc7BNMOIw%3D%3D&ver=1.3&_returnType=json",
	        type: "get",
	        dataType:"jsonp",
	        crossDomain: true,
	        success:function(data){
